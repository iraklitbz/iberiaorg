    ...
    <Header />
      <section className="position-relative z-index-1 container max-width-adaptive-sm padding-y-lg margin-top-xl">
        <article className="article text-component">
              ...
              <p className="text-md color-contrast-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
              ...
              <div className="text-component__block text-component__block--outset">
                <h3 className="text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repudiandae officiis similique enim?</h3>
              </div>
