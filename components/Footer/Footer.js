                ...
                <ul className="grid gap-lg">
                  <li className="col-6@sm col-3@md">
                    <div className="main-footer__items">
                      ...
                      <div className="main-footer__item"><a href="shop.html" className="main-footer__link">All Products</a></div>
                      <div className="main-footer__item"><a href="shop-categories.html" className="main-footer__link">Categories</a>
                      </div>
                      <div className="main-footer__item"><a href="product-v1.html" className="main-footer__link">Product v1</a></div>
                      <div className="main-footer__item"><a href="product-v2.html" className="main-footer__link">Product v2</a></div>
                      <div className="main-footer__item"><a href="cart.html" className="main-footer__link">Cart</a></div>
                      <div className="main-footer__item"><a href="checkout.html" className="main-footer__link">Checkout</a></div>
                    </div>
                  </li>
                  ...
                  <li className="col-6@sm col-3@md">
                    <div className="main-footer__items">
                      ...
                      <div className="main-footer__item"><a href="index.html" className="main-footer__link">Home v1</a></div>
                      <div className="main-footer__item"><a href="home-v2.html" className="main-footer__link">Home v2</a></div>
                      <div className="main-footer__item"><a href="about-us.html" className="main-footer__link">About Us</a></div>
                      <div className="main-footer__item"><a href="404.html" className="main-footer__link">404</a></div>
                      <div className="main-footer__item"><a href="thank-you.html" className="main-footer__link">Thank You</a></div>
                      <div className="main-footer__item"><a href="basic-page.html" className="main-footer__link">Basic Page</a></div>
                    </div>
                  </li>
                  ...
                  <li className="col-6@sm col-3@md">
                    <div className="main-footer__items">
                      ...
                      <div className="main-footer__item"><a href="blog.html" className="main-footer__link">Blog Gallery v1</a></div>
                      <div className="main-footer__item"><a href="blog-v2.html" className="main-footer__link">Blog Gallery v2</a>
                      </div>
                      <div className="main-footer__item"><a href="blog-post.html" className="main-footer__link">Blog Post</a></div>
                    </div>
                  </li>
                  ...
                  <li className="col-6@sm col-3@md">
                    <div className="main-footer__items">
                      ...
                      <div className="main-footer__item"><a href="account-settings.html" className="main-footer__link">Settings</a>
                      </div>
                      <div className="main-footer__item"><a href="account-addresses.html" className="main-footer__link">Addresses</a>
                      </div>
                      <div className="main-footer__item"><a href="account-order-history.html" className="main-footer__link">Order
                          History</a></div>
                      <div className="main-footer__item"><a href="account-order-details.html" className="main-footer__link">Order
                          Details</a></div>
                      <div className="main-footer__item"><a href="account-wishlist.html" className="main-footer__link">Wishlist</a>
                      </div>
                      <div className="main-footer__item"><a href="account-payment-methods.html" className="main-footer__link">Payment
                          Methods</a></div>
                    </div>
                  </li>
                </ul>
